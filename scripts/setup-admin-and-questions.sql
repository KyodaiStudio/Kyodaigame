...
('admin', 'admin123', 'admin@gameindo.com')
ON CONFLICT (username) DO UPDATE SET password_hash = 'admin123';

-- 3. Pastikan tabel questions ada dan memiliki struktur yang benar
...
-- 5. Hapus soal lama dan insert soal baru
DELETE FROM questions;

-- Insert soal Level 1-3 (total 30 soal)
