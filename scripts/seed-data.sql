...
INSERT INTO levels (level_number, name, difficulty, required_questions, passing_score, time_limit) VALUES
(1, 'Level 1 - Pengenalan', 'Mudah', 10, 60, 30),
(2, 'Level 2 - Dasar', 'Mudah', 10, 60, 30),
(3, 'Level 3 - Pemahaman', 'Mudah', 10, 65, 30),
(4, 'Level 4 - Penerapan', 'Sedang', 15, 65, 25),
(5, 'Level 5 - Analisis', 'Sedang', 15, 70, 25),
(6, 'Level 6 - Sintesis', 'Sedang', 15, 70, 25),
(7, 'Level 7 - Evaluasi', 'Sulit', 20, 75, 20),
(8, 'Level 8 - Kreasi', 'Sulit', 20, 75, 20),
(9, 'Level 9 - Inovasi', 'Sulit', 20, 80, 20),
(10, 'Level 10 - Mastery', 'Sangat Sulit', 25, 80, 15),
(11, 'Level 11 - Expert', 'Sangat Sulit', 25, 85, 15),
(12, 'Level 12 - Grandmaster', 'Sangat Sulit', 25, 90, 15)
ON CONFLICT (level_number) DO NOTHING;

-- Menambahkan soal untuk Level 1 (Mudah)
...
-- Menambahkan soal untuk Level 2 (Mudah)
INSERT INTO questions (question, option_a, option_b, option_c, option_d, correct_answer, explanation, level_id) VALUES
...
-- Menambahkan soal untuk Level 3 (Mudah)
INSERT INTO questions (question, option_a, option_b, option_c, option_d, correct_answer, explanation, level_id) VALUES
...
-- Menambahkan soal untuk Level 4 (Sedang)
INSERT INTO questions (question, option_a, option_b, option_c, option_d, correct_answer, explanation, level_id) VALUES
('Siapa yang memimpin perlawanan Perang Padri?', 'Tuanku Imam Bonjol', 'Cut Nyak Dhien', 'Sultan Hasanuddin', 'Pattimura', 0, 'Tuanku Imam Bonjol memimpin perlawanan Perang Padri.', 4),
('Apa nama perjanjian yang mengakhiri Perang Jawa?', 'Perjanjian Giyanti', 'Perjanjian Bongaya', 'Perjanjian Tuntang', 'Perjanjian Salatiga', 0, 'Perjanjian Giyanti mengakhiri Perang Jawa.', 4),
('Kapan VOC didirikan?', '1602', '1601', '1603', '1604', 0, 'VOC didirikan pada tahun 1602.', 4),
('Apa nama sistem tanam paksa yang diterapkan Belanda?', 'Cultuurstelsel', 'Landrent', 'Contingenten', 'Herendiensten', 0, 'Cultuurstelsel adalah sistem tanam paksa Belanda.', 4),
('Siapa Gubernur Jenderal yang menerapkan sistem tanam paksa?', 'Johannes van den Bosch', 'Herman Willem Daendels', 'Thomas Stamford Raffles', 'Jan Pieterszoon Coen', 0, 'Johannes van den Bosch menerapkan sistem tanam paksa.', 4),
('Apa nama organisasi pergerakan nasional pertama?', 'Budi Utomo', 'Sarekat Islam', 'Indische Partij', 'Jong Java', 0, 'Budi Utomo adalah organisasi pergerakan nasional pertama.', 4),
('Siapa pendiri Taman Siswa?', 'Ki Hajar Dewantara', 'Dr. Wahidin Sudirohusodo', 'Douwes Dekker', 'Dr. Cipto Mangunkusumo', 0, 'Ki Hajar Dewantara mendirikan Taman Siswa.', 4),
('Kapan Peristiwa Rengasdengklok terjadi?', '16 Agustus 1945', '15 Agustus 1945', '17 Agustus 1945', '18 Agustus 1945', 0, 'Peristiwa Rengasdengklok terjadi pada 16 Agustus 1945.', 4),
('Apa nama kapal yang membawa Soekarno-Hatta ke Rengasdengklok?', 'Tidak ada, mereka dibawa dengan mobil', 'KRI Dewantara', 'KRI Gadjah Mada', 'KRI Hasanuddin', 0, 'Soekarno-Hatta dibawa ke Rengasdengklok dengan mobil.', 4),
('Siapa yang mengetik naskah proklamasi?', 'Sayuti Melik', 'Sukarni', 'Chaerul Saleh', 'Wikana', 0, 'Sayuti Melik mengetik naskah proklamasi.', 4),
('Apa nama gedung tempat proklamasi dibacakan?', 'Rumah Soekarno di Jalan Pegangsaan Timur 56', 'Gedung Joang 45', 'Istana Merdeka', 'Gedung Pancasila', 0, 'Proklamasi dibacakan di rumah Soekarno di Jalan Pegangsaan Timur 56.', 4),
('Siapa yang menjahit bendera pusaka?', 'Fatmawati', 'Ibu Inggit Garnasih', 'Dewi Sartika', 'Cut Nyak Dhien', 0, 'Fatmawati menjahit bendera pusaka.', 4),
('Apa nama peristiwa penculikan Soekarno-Hatta oleh golongan muda?', 'Peristiwa Rengasdengklok', 'Peristiwa 10 November', 'Peristiwa Bandung Lautan Api', 'Peristiwa Tiga Daerah', 0, 'Peristiwa Rengasdengklok adalah penculikan Soekarno-Hatta.', 4),
('Kapan BPUPKI dibentuk?', '29 April 1945', '1 Maret 1945', '1 Juni 1945', '18 Agustus 1945', 0, 'BPUPKI dibentuk pada 29 April 1945.', 4),
('Siapa ketua BPUPKI?', 'Dr. Radjiman Wedyodiningrat', 'Ir. Soekarno', 'Drs. Mohammad Hatta', 'Mr. Ahmad Subardjo', 0, 'Dr. Radjiman Wedyodiningrat adalah ketua BPUPKI.', 4);
